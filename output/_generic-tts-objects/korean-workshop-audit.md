...
## Script Repo Audit
- Target repo inside Lua scripts: 1631
...
- `Load stats` original=1848 patched=1816
- `KTUI` original=26850 patched=26381
- `KTUIMiniDatacard` original=1387 patched=1363
- `addContextMenuItem("Update"` original=0 patched=0
- `click_update_single_object` original=3334 patched=3258
...
- Official Korean team `angels-of-death`: `https://raw.githubusercontent.com/mightyTeddy922/kt-datacards-kor/main/output/angels-of-death/cards/datacards/assault-intercessor-grenadier-front.jpg`
- Official Korean team `battleclade`: `https://raw.githubusercontent.com/mightyTeddy922/kt-datacards-kor/main/output/battleclade/cards/datacards/battleclade-auto-proxy-servitor-front.jpg`
